/* Unit tests for frng64_lecuyer_simard.c
...
const double lecuyer_simard_T[] = {0x1.5003f00fc017ap-10,
...
TESTING_FRNG64(lecuyer_simard,seed,irng);

Suite *frng64_LES_suite(void)
{
  Suite *s;
  TCase *tc_core;
  ...
  s = suite_create("frng64_lecuyer_simard");
  
  /* Core test case */
  tc_core = tcase_create("Core");
	ADD_TEST_FRNG64(lecuyer_simard);
